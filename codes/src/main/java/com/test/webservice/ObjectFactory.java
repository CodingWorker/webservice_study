...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webservice.test.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://webservice.test.com/", "queryWeather");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.test.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.test.com/", name = "queryWeather")
